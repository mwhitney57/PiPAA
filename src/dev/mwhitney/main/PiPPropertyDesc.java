...
public final class PiPPropertyDesc {
    ...
    public static final String
        ...
        USE_SUPER_RES         = "Configure new PiPAA windows to be capable of utilizing NVIDIA's RTX Video Super Resolution feature. Utilizes hardware decoding and may degrade or destabilize performance. ONLY AVAILABLE ON LATEST VLC VERSIONS WITH SUPPORTED NVIDIA RTX (GPUs).",
