...
/**
 * A generic function that takes four arguments, returns a value, and may throw
 * an {@link Exception}.
 * 
 ...
 */
@FunctionalInterface
public interface TRFunctionIV<P, P2, P3, P4, R, E extends Exception> {
    /**
     ...
     */
    public R apply(P arg1, P2 arg2, P3 arg3, P4 arg4) throws E;
}
