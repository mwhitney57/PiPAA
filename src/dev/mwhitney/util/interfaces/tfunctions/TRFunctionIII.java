...
/**
 * A generic function that takes three arguments, returns a value, and may throw
 * an {@link Exception}.
 * 
 ...
 */
@FunctionalInterface
public interface TRFunctionIII<P, P2, P3, R, E extends Exception> {
    /**
     ...
     */
    public R apply(P arg1, P2 arg2, P3 arg3) throws E;
}
