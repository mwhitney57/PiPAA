...
import dev.mwhitney.gui.components.better.BetterCheckbox;
import dev.mwhitney.gui.components.better.BetterComboBox;
import dev.mwhitney.gui.components.better.BetterLabel;
import dev.mwhitney.gui.components.better.BetterPanel;
import dev.mwhitney.gui.components.better.BetterSlider;
import dev.mwhitney.gui.components.better.BetterTabbedPane;
            ...
            CompletableFuture.runAsync(() -> {
                ...
                if (result.checked()) {
                    ...
                    if (!result.userPrompted()) EasyTopDialog.showMsg(this,
                            result.hasException() ? result.exception().getUserFriendlyErrorMessage() : "No update available.",
