 ...
 * @author mwhitney57
 */
public abstract class PiPWindowManagerAdapter implements PiPWindowManagerListener, PiPHandoffListener, PiPAttributeRequestListener  {
    ...
    @Override
    public PiPMediaAttributes requestAttributes(PiPMedia media, boolean raw) { return null; }
}
